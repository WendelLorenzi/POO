...
public class JanelaAlteraEstudo implements ActionListener{
    ...
    static JLabel rotulo2= new JLabel("Digite o peso suportado: ");
    ...
    static JanelaAlteraEstudo jae= new JanelaAlteraEstudo();
    ...
    static JTextField caixa6= new JTextField(15);
      ...
      public void abreJanAltEst(){
        int larg= 300;
        int alt= 500;
        janela.setSize(larg,alt);
        janela.setTitle("Altera Mesa Estudo");
      ...
      janela.add(botao4);
        ...
        botao1.addActionListener(jae);
        botao2.addActionListener(jae);
        botao4.addActionListener(jae);
        ...
        s.alteraMesaEstudo(Integer.parseInt(caixa1.getText()), (caixa2.getText()), (caixa3.getText()),(caixa4.getText()), (caixa5.getText()), (caixa6.getText()));
         }
